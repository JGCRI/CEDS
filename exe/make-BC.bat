...
SET PATH=%PATH%;C:\Users\feng999\Documents\CEDS\exe\needed-exes\bin;C:\Program Files\R\R-3.2.2\bin\x64;


SET R_LIBS_USER=C:\Users\feng999\Documents\R\win-library\3.2
...
IF [%1]==[] ( SET CMD=BC-emissions ) ELSE ( set CMD=%1 )
