...
# Stacked Sector 
pdf(paste0('../diagnostic-output/paper-figures/Supplement/Recent_Paper_Figures_sector_stacked.pdf'),width=9.5,height=8.5,paper='special', onefile=F)
...
# Line Sector
pdf(paste0('../diagnostic-output/paper-figures/Supplement/Recent_Paper_Figures_sector_line.pdf'),width=9.5,height=8.5,paper='special', onefile=F)
...
dev.off()
# Stacked Region
pdf(paste0('../diagnostic-output/paper-figures/Paper/Recent_Paper_Figures_region_stacked.pdf'),width=9.5,height=8.5,paper='special', onefile=F)
...
pdf(paste0('../diagnostic-output/paper-figures/Supplement/Recent_Paper_Figures_region_line.pdf'),width=9.5,height=8.5,paper='special', onefile=F)
...
# Stacked fuel
pdf(paste0('../diagnostic-output/paper-figures/Supplement/Recent_Paper_Figures_fuel_stacked.pdf'),width=9.5,height=8.5,paper='special', onefile=F)
...
pdf(paste0('../diagnostic-output/paper-figures/Supplement/Recent_Paper_Figures_fuel_line.pdf'),width=9.5,height=8.5,paper='special', onefile=F)
