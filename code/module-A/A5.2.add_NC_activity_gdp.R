...
# Input Files: A.NC_activty_db.csv, 2011_NC_SO2_ctry.csv, GDP.xlsx, activity_input_mapping.xlsx
...
results <- cbind( activity_data[ c( "iso","activity","units" ) ] , activity_data[ 2:( length( activity_data ) - 3 ) ] )
