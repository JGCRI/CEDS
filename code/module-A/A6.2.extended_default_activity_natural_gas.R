...
#                 * Merge IEA coal data (2014 - 1960/1971) to UNSD NG data (1959/1970 - 1950)
...
# Output Files:  A.comb_activity_extended_natural_gas.csv
...
log_msg <- "Extending natural gas data with CDIAC and UNSD data..." # First message to be printed to the log
...
printLog( 'Disaggregating total natural gas into fuel types...' )
