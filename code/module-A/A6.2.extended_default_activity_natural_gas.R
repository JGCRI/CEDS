# ------------------------------------------------------------------------------
# Program Name: A6.2.default_actvity_natural_gas.R
...
script_name <- "A6.2.default_actvity_natural_gas.R"
...
#-----------------------------------------------------------------------------------------------
# 3. Print output
writeData( CEDS_default_actvity , "MED_OUT", "A.CEDS_combustion_activity_extended_natural_gas" )
