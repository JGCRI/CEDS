...
F.readScalingData <- function( inventory = inventory_data_file, inv_data_folder,
  ...
  scaling_map <- OldtoNewCEDSSectors(scaling_map)
...
#   inv_sector_name: sector as labeled in the inventory
#   X_inv_years: a vector of the inventory's years with an "X" in front of it
#   em: emission species
