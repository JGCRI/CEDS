...
driver_info <- unique(extension_drivers_all[which( extension_drivers_all$driver_data_source == 'CDIAC' ), 
                                            'extra_driver_info'])
...
extension_drivers <- extension_drivers_all[which( extension_drivers_all$driver_data_source == 'CDIAC' ), ]
