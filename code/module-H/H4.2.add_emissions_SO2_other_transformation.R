# ------------------------------------------------------------------------------
# Program Name: H4.2.add_emissions_SO2_other_transformation.R
...
script_name <- "H4.2.add_emissions_SO2_other_transformation.R"
...
other_transformation_coal <- readData('DIAG_OUT', 'H.Extended_other_tranformation_coal' )
