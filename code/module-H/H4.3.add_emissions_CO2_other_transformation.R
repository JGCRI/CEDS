...
# a. Extend Coal Coke (imports - exports) with extended coal coke (production + imports - exports)
  ...
  IEA_coke_extended[ forward_ext_years ] <- replicate(ratio$ratio_recent, n = length(forward_ext_years)) * extended_coke[ which( extended_coke$iso %in% countries) , forward_ext_years ]
