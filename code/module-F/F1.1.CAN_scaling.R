#------------------------------------------------------------------------------
# Program Name: F1.1.CAN_scaling_2018.R
...
#                  format used since 2012. This data only extends back to 1990,
#                  so older data is still used back to 1985 in a separate
...
# provide logging, file support, and system functions - and start the script log.
    ...
    log_msg <- "Canada inventory scaling (2018)" # First message to be printed to the log
    script_name <- paste0( em, "-F1.1.CAN_scaling_2018.R" )
...
#   the inventory (as a vector of iso codes)
    sector_fuel_mapping <- 'CAN' #_scaling_mapping'
