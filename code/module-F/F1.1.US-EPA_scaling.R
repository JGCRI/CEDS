#------------------------------------------------------------------------------
# Program Name: F1.1.US-EPA_scaling.R
# Authors' Names: Linh Vu
# Date Last Modified: 9 Sept 2016
# Program Purpose: To create scaling factors and update emissions estimate for
# the USA region from latest emissions working copy by using US EPA inventory
# data
# Input Files: emissions_scaling_functions.R, F.[em]_scaled_EF.csv, 
#              F.[em]_scaled_emissions.csv, US-EPA_scaling_mapping.xlsx
#              E.[em]_US-EPA_inventory.csv
...
# provide logging, file support, and system functions - and start the script log.
    ...
    script_name <- paste0( em, "-F1.1.US-EPA_scaling.R" )
...
#   the inventory (as a vector of iso codes)
    ...
    region <- c( "usa" ) 
    sector_fuel_mapping <- 'US-EPA_scaling_mapping'
