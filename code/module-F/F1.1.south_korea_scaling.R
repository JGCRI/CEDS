...
# the South Korea from latest emissions working copy by using aggregate 
# inventory data.
# This uses data from 1999 - 2012
...
script_name <- "F1.1.south_korea_scaling.R"
...
inventory_data_file <- paste0('Korea/E.',em,'_',inv_name,'_inventory')
inv_data_folder <- 'EM_INV'
