...
# Identify all isos with EDGAR data
    region <-  c( "abw", "afg", "ago", "aia", "air", "alb", "ant", "are",
                  "arg", "arm", "atg", "aus", "aut", "aze", "bdi", "bel",
                  "ben", "bfa", "bgd", "bgr", "bhs", "bih", "blr", "blz",
                  "bmu", "bol", "bra", "brb", "brn", "btn", "bwa", "caf",
                  "can", "che", "chl", "chn", "civ", "cmr", "cod", "cog",
                  "cok", "col", "com", "cpv", "cri", "cub", "cym", "cyp",
                  "cze", "deu", "dji", "dma", "dnk", "dom", "dza", "ecu",
                  "egy", "eri", "esh", "esp", "est", "eth", "fin", "fji",
                  "flk", "fra", "fro", "gab", "gbr", "geo", "gha", "gib",
                  "gin", "glp", "gmb", "gnb", "gnq", "grc", "grd", "grl",
                  "gtm", "guf", "guy", "hkg", "hnd", "hrv", "hti", "hun",
                  "idn", "irl", "irn", "irq", "isl", "isr", "ita", "jam",
                  "jor", "jpn", "kaz", "ken", "kgz", "khm", "kir", "kna",
                  "kor", "kwt", "lao", "lbn", "lbr", "lby", "lca", "lka",
                  "lso", "ltu", "lux", "lva", "mac", "mar", "mda", "mdg",
                  "mdv", "mex", "mkd", "mli", "mmr", "mng", "moz", "mrt",
                  "msr", "mtq", "mus", "mwi", "mys", "nam", "ncl", "ner",
                  "nga", "nic", "nld", "nor", "npl", "nzl", "omn", "pak",
                  "pan", "per", "phl", "plw", "png", "pol", "pri", "prk",
                  "prt", "pry", "pyf", "qat", "reu", "rou", "rus", "rwa",
                  "sau", "scg", "sdn", "sea", "sen", "sgp", "shn", "slb",
                  "sle", "slv", "som", "spm", "stp", "sur", "svk", "svn",
                  "swe", "swz", "syc", "syr", "tca", "tcd", "tgo", "tha",
                  "tjk", "tkm", "tls", "ton", "tto", "tun", "twn", "tza",
