...
#              EMEP_NFR14_scaling_mapping.csv, EMEP_NFR14_scaling_year.csv,
#              EMEP_NFR14_SO2_scaling_mapping.csv, EMEP_NFR14_SO2_scaling_year.csv,
#              EMEP_NFR14_SO2_scaling_method.csv
...
# provide logging, file support, and system functions - and start the script log.
    ...
    log_msg <- "Modifying emissions factors from EMEP NFR14 inventory data..." # First message to be printed to the log
