...
log_msg <- "South Korea HTAP inventory scaling..." # First message to be printed to the log
script_name <- paste0( em, "-F1.1.South_Korea_EDGAR-HTAPv3.1_scaling.R" )
...
sector_fuel_mapping <- 'EDGAR_HTAPv3.1_kor'
...
inv_name <- 'EDGAR_HTAPv3.1_kor' #for naming diagnostic files
