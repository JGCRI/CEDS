#------------------------------------------------------------------------------
# Program Name: F1.1.Japan_scaling.R
...
#                  the Japan region from latest emissions working copy by using
#                  aggregate Japan trends inventory data.
...
# Stop script if running for unsupported species
    if ( em %!in% c( 'SO2', 'NOx', 'CO', 'NMVOC', 'NH3','BC','OC' ) ) {
      stop( paste( 'Japan scaling is not supported for emission species ',
