...
#                  the China region from latest emissions working copy by using
#                  aggregate.
...
# Notes: (1) MEIC trends inventory data.
#        (2) This data only contains data from 2008,2010,2012.
