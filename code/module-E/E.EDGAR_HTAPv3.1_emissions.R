# ------------------------------------------------------------------------------
# Program Name: E.EDGAR_HTAPv3.1_emissions.R
...
log_msg <- "Process EDGAR_HTAPv3.1" # First message to be printed to the log
script_name <- "EDGAR_HTAPv3.1_emissions.R"
...
inventory_data_file <- paste0("EDGAR_HTAPv3.1_", em)
inv_data_sheet <- paste0("edgar_HTAPv3_1_", em)
inv_data_folder <- "EM_INV"
subfolder_name <- 'EDGAR_HTAPv3.1/'
inv_name <- 'EDGAR_HTAPv3.1' #for naming diagnostic files
...
inv_in <- readData(domain = "EM_INV",
                       ...
                       extension = ".xlsx",
                       sheet_selection = inv_data_sheet)
