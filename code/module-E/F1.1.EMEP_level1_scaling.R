#------------------------------------------------------------------------------
# Program Name: F1.1.EMEP_level1_scaling.R
# Authors' Names: Patrick O'Rourke, adapted from format created by Rachel Hoesly
...
#              E.[em]_EMEP_lvl1_inventory.csv
# Output Files: F.[em]_total_scaled_EF.csv, F.[em]_total_scaled_emissions.csv
# Notes: 
# TODO: 1.) Include a function to specify which sectors should not be scaled for certain years for certain countries
#       2.) Include a function to specify which sectors should not be scaled for certain countries at all
...
script_name <- "F1.1.EMEP_level1_scaling.R"
...
inventory_data_file <- paste0("E.", em, "_EMEP_lvl1_inventory")
