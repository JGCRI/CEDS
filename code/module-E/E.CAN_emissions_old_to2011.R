#------------------------------------------------------------------------------
# Program Name: E.CAN_emissions_old_to2011.R
...
# Output Files: E.[em]_CAN_old_to2011_inventory.csv
# Notes:
# TODO:
# ------------------------------------------------------------------------------
...
# provide logging, file support, and system functions - and start the script log.
    ...
    log_msg <- "Initial reformatting of Canada emissions (older data to 2011)" # First message to be printed to the log
