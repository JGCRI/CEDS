...
# This file uses the newer format used since 2012.
...
# Set working directory to the CEDS âinputâ directory and define PARAM_DIR as the
# location of the CEDS âparametersâ directory relative to the new working directory.
