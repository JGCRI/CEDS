...
# Date Last Updated: March 21, 2017
#
...
#               E.[EM]__UNFCCC_inventory
#               E.[EM]_UNFCCC_filename_Sector_mapping
#
...
#-------------------------------------------------------------------------------------------------------
#FUNCTION NAME: check_uniqueID_and_species_mismatch
...
#OUTPUT FILES: E.[EM]__UNFCCC_inventory: Generates a diagnostic this file if a specie/id mismatch is detected
#              E.[EM]_UNFCCC_filename_Sector_mapping: This file contains a list of filename to sector mapping within the emission specie folder
...
check_uniqueID_and_species_mismatch <- function( UNFCCC_DF, UNFCCC_FILE_NAMES){
  ...
  if(length(diagnostic_error_data) > 0){
    ...
    writeData( diagnostic_error_data, domain = "DIAG_OUT", fn = paste0( "E.", em, "_UNFCCC_inventory" ), meta = FALSE )
  }
