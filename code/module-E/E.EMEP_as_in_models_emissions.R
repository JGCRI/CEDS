...
writeData( inv , 'EM_INV', domain_extension = "EMEP/" , fn = paste0('EMEP_SNAP_', em.read, "_As-in-models"),
           meta = TRUE)
# -----------------------------------------------------------------------------------------------------------
# 1. Read in files
EMEP <- readData('EM_INV', domain_extension = "EMEP/",  paste0('EMEP_SNAP_', em.read, "_As-in-models" ) )
...
#   Write Data:
    writeData(EMEP_emdf, domain = "MED_OUT", fn = paste0( "E.", em, "_EMEP_as-in-models_inventory" ), meta = TRUE )
