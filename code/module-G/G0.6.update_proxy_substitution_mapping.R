# ------------------------------------------------------------------------------
# Program Name: G0.6.update_proxy_substitution_mapping.R
# Authors: Noah Prime
...
# Replace these findings in the proxy substitution mapping for this species
# proxy_substitution_mapping <- proxy_substitution_mapping %>%
#     dplyr::filter(em != !!em) %>%
#     dplyr::bind_rows(res_df_long)
