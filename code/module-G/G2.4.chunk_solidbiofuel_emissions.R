...
log_msg <- "Generates chunk NetCDF files for solid biofuel emissions" # First message to be printed to the log
script_name <- "G2.4.chunk_solidbiofuel_emissions.R"
