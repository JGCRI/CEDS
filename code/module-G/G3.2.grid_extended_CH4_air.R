# ------------------------------------------------------------------------------
# Program Name: G3.2.grid_extended_CH4_air.R
...
# provides logging, file support, and system functions - and start the script log.
  ...
  log_msg <- "Gridding CH4 anthropogenic aircraft emissions" # First message to be printed to the log
  script_name <- "G3.2.grid_extended_CH4_air.R"
...
# 5. Write-out and Stop 
    out_name <- paste0( 'G.', em, '_extended_AIR_emissions_checksum_comparison_diff' )
    writeData( diag_diff_df, "DIAG_OUT", out_name )
    out_name <- paste0( 'G.', em, '_extended_AIR_emissions_checksum_comparison_per' )
